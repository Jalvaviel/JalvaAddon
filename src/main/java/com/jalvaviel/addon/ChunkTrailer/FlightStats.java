...
public record FlightStats(int version, Dimension dimension, ReplayMode mode, String timestamp, String duration,
    ...
    public static FlightStats genDummyMetadata(ReplayMode mode) {
        return new FlightStats(REPLAY_VERSION, PlayerUtils.getDimension(),mode,
